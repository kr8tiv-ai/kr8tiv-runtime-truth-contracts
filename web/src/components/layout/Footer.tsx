...
const SOCIAL_LINKS = [
  { href: 'https://t.me/KinCompanionBot', label: 'Telegram', icon: TelegramIcon },
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-white/50 leading-relaxed max-w-xs">
              AI companions that grow with you. Chat, create, and build together on Telegram.
            </p>
          </div>

          {/* Links */}
          <div>
            <h3 className="font-display text-sm font-semibold text-white/90 uppercase tracking-wider mb-4">
              Product
            </h3>
          ...
          <div>
            ...
            <p className="text-sm text-white/50 leading-relaxed mb-4">
              Jump straight into Telegram and start chatting with your companion.
            </p>
            <a
              href="https://t.me/KinCompanionBot"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-full bg-cyan/10 border border-cyan/20 px-4 py-2 text-sm font-medium text-cyan transition-all duration-200 hover:bg-cyan/20"
            >
